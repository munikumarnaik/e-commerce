...
mixin _$AuthState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(User user, AuthTokens tokens) authenticated,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(User user, AuthTokens tokens)? authenticated,
...
class _$AuthAuthenticatedImpl implements AuthAuthenticated {
  const _$AuthAuthenticatedImpl({required this.user, required this.tokens});
...
abstract class AuthAuthenticated implements AuthState {
  const factory AuthAuthenticated(
      ...
      required final AuthTokens tokens}) = _$AuthAuthenticatedImpl;
